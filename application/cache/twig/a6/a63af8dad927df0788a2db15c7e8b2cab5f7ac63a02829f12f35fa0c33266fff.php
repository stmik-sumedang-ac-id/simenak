...
/* standar/form.twig */
class __TwigTemplate_1a983298fcb828f40594a08ba0d77e1510a7a7f854e45bac172550a34d7dae50 extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"tile\">
        ...
        // line 13
        echo twig_escape_filter($this->env, base_url(("standar/aksi_" . ($context["aksi"] ?? null))), "html", null, true);
        echo "\">
        ...
        // line 25
        echo twig_escape_filter($this->env, $this->getAttribute(($context["standar"] ?? null), "nama", array()), "html", null, true);
        echo "\">
            </div>
        ...
        // line 32
        echo twig_escape_filter($this->env, base_url(("standar/index/" . $this->getAttribute(($context["versi"] ?? null), "id", array()))), "html", null, true);
...
{% endblock %}", "standar/form.twig", "/Users/yysofiyan/Desktop/Gitlab/borang_stmik/application/views/standar/form.twig");
    }
}
