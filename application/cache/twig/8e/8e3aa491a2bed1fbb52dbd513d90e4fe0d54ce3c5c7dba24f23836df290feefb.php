...
/* pengajuan/form.twig */
class __TwigTemplate_38c756be8ef9152a732e27f0af49394393c3f3569103a765042dda0365495db9 extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"tile\">
        ...
        // line 13
        echo twig_escape_filter($this->env, base_url(("pengajuan/aksi_" . (isset($context["aksi"]) ? $context["aksi"] : null))), "html", null, true);
        echo "\">
            
            <input type=\"hidden\" name=\"where[id]\" value=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["pengajuan"]) ? $context["pengajuan"] : null), "id", array()), "html", null, true);
        echo "\">
        ...
        // line 19
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["pengajuan"]) ? $context["pengajuan"] : null), "tahun_usulan", array()), "html", null, true);
        echo "\">
            </div>
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["CI"]) ? $context["CI"] : null), "db", array()), "get", array(0 => "versi"), "method"), "result", array(), "method"));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 26
            echo "                  ";
            if (($this->getAttribute($context["item"], "id", array()) == $this->getAttribute((isset($context["pengajuan"]) ? $context["pengajuan"] : null), "versi_id", array()))) {
                // line 27
...
{% endblock %}", "pengajuan/form.twig", "/Users/yysofiyan/Desktop/Gitlab/ta_borang/application/views/pengajuan/form.twig");
    }
}
