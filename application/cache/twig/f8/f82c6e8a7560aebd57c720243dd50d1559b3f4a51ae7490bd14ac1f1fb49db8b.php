...
/* prodi/form.twig */
class __TwigTemplate_51720435fe9cbcba20e23600e687a2f84b58095ed722aaea704e29fae1686149 extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"tile\">
        ...
        // line 13
        echo twig_escape_filter($this->env, base_url(("prodi/aksi_" . ($context["aksi"] ?? null))), "html", null, true);
        echo "\">
            
            <input type=\"hidden\" name=\"where[id]\" value=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->getAttribute(($context["prodi"] ?? null), "id", array()), "html", null, true);
        echo "\">
            <input type=\"hidden\" name=\"data[fakultas_id]\" value=\"";
        // line 16
        echo twig_escape_filter($this->env, (((($context["prodi"] ?? null) != null)) ? ($this->getAttribute(($context["prodi"] ?? null), "fakultas_id", array())) : ($this->getAttribute(($context["fakultas"] ?? null), "id", array()))), "html", null, true);
        echo "\">
        ...
        // line 20
        echo twig_escape_filter($this->env, $this->getAttribute(($context["prodi"] ?? null), "nama", array()), "html", null, true);
        echo "\">
            </div>
        ...
        // line 27
        echo twig_escape_filter($this->env, base_url(("prodi/index/" . $this->getAttribute(($context["fakultas"] ?? null), "id", array()))), "html", null, true);
...
{% endblock %}", "prodi/form.twig", "/Users/yysofiyan/Desktop/Gitlab/borang_stmik/application/views/prodi/form.twig");
    }
}
