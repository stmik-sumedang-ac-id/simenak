...
/* pengajuan/crud.twig */
class __TwigTemplate_a1b7f7385d71e092a19dbd51bc645413a15fa992b43b21effa66995afc75d557 extends Twig_Template
{
...
";
  ...
  \$(\"#tambah_pengajuan\").click(function() {
    \$.ajax({
      url: \"";
        // line 102
        echo twig_escape_filter($this->env, base_url(("pengajuan/ajax_cek_blm_kelar/" . $this->getAttribute($this->getAttribute((isset($context["CI"]) ? $context["CI"] : null), "session", array()), "prodi_id", array()))), "html", null, true);
        echo "\",
      success: function(data) {
          // console.log(data);
          if (data == '1') {
...
{% endblock %}", "pengajuan/crud.twig", "/Users/yysofiyan/Desktop/Gitlab/ta_borang/application/views/pengajuan/crud.twig");
    }
}
