...
class __TwigTemplate_d4067bd46a8bb7f0740bb5e4de8bc00a6685c667a795ef05abd3224140f0486f extends Twig_Template
{
...
<html lang=\"en\">
  ...
  <body class=\"app sidebar-mini rtl\">
    ...
    <header class=\"app-header\"><a class=\"app-header__logo\" href=\"";
        ...
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["CI"] ?? null), "db", array()), "get", array(0 => "config"), "method"), "row", array(), "method"), "judul_menu", array()), "html", null, true);
        echo "</a>
    ...
    <aside class=\"app-sidebar\">
      ...
      ";
        // line 42
        if (file_exists(("uploads/userimage/" . $this->getAttribute($this->getAttribute(($context["CI"] ?? null), "session", array()), "id", array())))) {
            // line 43
            echo "        ";
            $context["userimage"] = ("uploads/userimage/" . $this->getAttribute($this->getAttribute(($context["CI"] ?? null), "session", array()), "id", array()));
            // line 44
            echo "      ";
        } else {
            // line 45
      ...
      <div class=\"app-sidebar__user\"><img class=\"app-sidebar__user-avatar\" src=\"";
        // line 48
        echo twig_escape_filter($this->env, ((base_url(($context["userimage"] ?? null)) . "?time=") . ($context["now"] ?? null)), "html", null, true);
        echo "\" alt=\"User Image\">
        <div>
          <p class=\"app-sidebar__user-name\">";
        // line 50
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["CI"] ?? null), "session", array()), "nama", array()), "html", null, true);
        echo "</p>
          <p class=\"app-sidebar__user-designation\">";
        // line 51
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["CI"] ?? null), "session", array()), "username", array()), "html", null, true);
        echo "</p>
        </div>
      </div>
      <ul class=\"app-menu\">
        ...
        ";
        // line 56
        if (($this->getAttribute($this->getAttribute(($context["CI"] ?? null), "session", array()), "level", array()) == 1)) {
            // line 57
            echo "          ";
...
($context["CI"] ?? null), "session", array()), "level", array()) == 2)) {
            // line 59
            echo "          ";
...
($context["CI"] ?? null), "session", array()), "level", array()) == 3)) {
            // line 61
            echo "          ";
...
</html>", "template/template.twig", "/home/u7998733/public_html/data/application/views/template/template.twig");
    }
}
