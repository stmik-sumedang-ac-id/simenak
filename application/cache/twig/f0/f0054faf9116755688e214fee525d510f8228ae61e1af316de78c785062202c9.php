...
/* butir/index.twig */
class __TwigTemplate_8f63f89066a37d6d984cf28d2014207f99877b5b8963f396f6ff23536572d3e7 extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"tile\">
        ...
        // line 14
        echo twig_escape_filter($this->env, base_url(("butir/tambah/" . $this->getAttribute((isset($context["substandar"]) ? $context["substandar"] : null), "id", array()))), "html", null, true);
...
";
  ...
  var table = \$('.datatable').DataTable( {
      ...
      \"ajax\": {
          \"url\": \"";
        // line 39
        echo twig_escape_filter($this->env, base_url(("butir/ajax/" . $this->getAttribute((isset($context["substandar"]) ? $context["substandar"] : null), "id", array()))), "html", null, true);
        echo "\",
          \"type\": \"POST\"
      },
      columnDefs: [
...
{% endblock %}", "butir/index.twig", "/Users/yysofiyan/Desktop/Gitlab/ta_borang/application/views/butir/index.twig");
    }
}
