...
/* fakultas/form.twig */
class __TwigTemplate_1713a26eb8ff0657864d883446beed3a3f3f261e6e6a2140e07b289872c3ab2d extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"tile\">
        ...
        // line 13
        echo twig_escape_filter($this->env, base_url(("fakultas/aksi_" . ($context["aksi"] ?? null))), "html", null, true);
        echo "\">
            
            <input type=\"hidden\" name=\"where[id]\" value=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->getAttribute(($context["fakultas"] ?? null), "id", array()), "html", null, true);
        echo "\">
...
{% endblock %}", "fakultas/form.twig", "/home/u7998733/public_html/data/application/views/fakultas/form.twig");
    }
}
