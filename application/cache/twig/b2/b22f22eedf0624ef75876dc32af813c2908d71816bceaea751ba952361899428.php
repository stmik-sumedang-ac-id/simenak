...
/* butir/form.twig */
class __TwigTemplate_75f2999e2c7d2f4426da90685406b626238d82a2aa760e7c537d21ff0217fb52 extends Twig_Template
{
  ...
  <div class=\"col-md-12\">
    <div class=\"tile\">
      ...
      <div class=\"tile-body\">
        ...
        // line 13
        echo twig_escape_filter($this->env, base_url(("butir/aksi_" . ($context["aksi"] ?? null))), "html", null, true);
        echo "\">
          
          <input type=\"hidden\" name=\"where[id]\" value=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->getAttribute(($context["butir"] ?? null), "id", array()), "html", null, true);
        echo "\">
          <input type=\"hidden\" name=\"data[substandar_id]\" value=\"";
        // line 16
        echo twig_escape_filter($this->env, $this->getAttribute(($context["substandar"] ?? null), "id", array()), "html", null, true);
        echo "\">
        ...
        // line 21
        echo twig_escape_filter($this->env, $this->getAttribute(($context["substandar"] ?? null), "nomor", array()), "html", null, true);
        echo ".</span></div>
              <input class=\"form-control\" type=\"number\" min=\"1\" max=\"100\" required placeholder=\"Masukan Nomor\" name=\"data[nomor]\" value=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute(explode(".", $this->getAttribute(($context["butir"] ?? null), "nomor", array())), 2, array(), "array"), "html", null, true);
        echo "\">
            </div>
          </div>
        ...
        // line 28
        echo twig_escape_filter($this->env, $this->getAttribute(($context["butir"] ?? null), "nama", array()), "html", null, true);
        echo "\">
          </div>
        ...
        // line 35
        echo twig_escape_filter($this->env, base_url(("butir/index/" . $this->getAttribute(($context["substandar"] ?? null), "id", array()))), "html", null, true);
...
{% endblock %}", "butir/form.twig", "/Users/yysofiyan/Desktop/Gitlab/borang_stmik/application/views/butir/form.twig");
    }
}
