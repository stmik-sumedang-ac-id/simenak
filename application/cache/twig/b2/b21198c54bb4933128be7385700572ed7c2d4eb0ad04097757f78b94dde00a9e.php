...
/* profil/index.twig */
class __TwigTemplate_6801f8d0033d8e4230d732856448c88d01889dc64c382cd38e257320b9b3cf37 extends Twig_Template
{
      ...
      <div class=\"tile\">
        ...
        echo "\">
            ...
            <div class=\"form-group\">
              ...
              ";
        // line 29
        if (($this->getAttribute(($context["user"] ?? null), "level", array()) == 1)) {
            // line 30
            echo "                ";
            $context["level"] = "Administrator";
            // line 31
            echo "              ";
        } elseif (($this->getAttribute(($context["user"] ?? null), "level", array()) == 2)) {
            // line 32
            echo "                ";
            $context["level"] = "DPM";
            // line 33
            ...
            // line 34
            echo "                ";
            $context["level"] = (("Prodi (" . $this->getAttribute(($context["addon"] ?? null), "prodi", array())) . ")");
            // line 35
            echo "              ";
        }
        // line 36
...
{% endblock %}", "profil/index.twig", "/Users/yysofiyan/Desktop/Gitlab/borang_stmik/application/views/profil/index.twig");
    }
}
