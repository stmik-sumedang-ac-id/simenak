...
class __TwigTemplate_65805c31eeee8f72ee1ead89e8d70438ab23d19b995a6dea177d161cac81e8c5 extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"tile\">
        ...
        // line 13
        echo twig_escape_filter($this->env, base_url(("substandar/aksi_" . ($context["aksi"] ?? null))), "html", null, true);
        echo "\">
        ...
        // line 21
        echo twig_escape_filter($this->env, $this->getAttribute(($context["standar"] ?? null), "nomor", array()), "html", null, true);
        echo ".</span></div>
                <input class=\"form-control\" type=\"number\" min=\"1\" max=\"100\" required placeholder=\"Masukan Nomor\" name=\"data[nomor]\" value=\"";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute(explode(".", $this->getAttribute(($context["substandar"] ?? null), "nomor", array())), 1, array(), "array"), "html", null, true);
        echo "\">
              </div>
            </div>
        ...
        // line 28
        echo twig_escape_filter($this->env, $this->getAttribute(($context["substandar"] ?? null), "nama", array()), "html", null, true);
        echo "\">
            </div>
        ...
        // line 35
        echo twig_escape_filter($this->env, base_url(("substandar/index/" . $this->getAttribute(($context["standar"] ?? null), "id", array()))), "html", null, true);
...
{% endblock %}", "substandar/form.twig", "/home/u7998733/public_html/data/application/views/substandar/form.twig");
    }
}
