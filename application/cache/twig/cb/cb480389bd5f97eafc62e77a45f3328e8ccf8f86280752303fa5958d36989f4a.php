...
/* user/ubah.twig */
class __TwigTemplate_079e36e886f4a94d5a956564f595894ce46382dd018c63faa356600b2c4b4004 extends Twig_Template
{
    ...
    <div class=\"col-md-12\">
      <div class=\"tile\">
        ...
        // line 19
        echo twig_escape_filter($this->env, $this->getAttribute(($context["user"] ?? null), "nama", array()), "html", null, true);
        echo "\">
            </div>
        ...
        echo "\">
            ...
            <div class=\"form-group\">
              ...
              <select id=\"level\" class=\"form-control select2\" required name=\"data[level]\">
                <option ";
        // line 30
        echo ((($this->getAttribute(($context["user"] ?? null), "level", array()) == "1")) ? ("selected") : (null));
        echo " value=\"1\">Administrator</option>
                <option ";
        // line 31
        echo ((($this->getAttribute(($context["user"] ?? null), "level", array()) == "2")) ? ("selected") : (null));
        echo " value=\"2\">DPM</option>
                <option ";
        // line 32
        echo ((($this->getAttribute(($context["user"] ?? null), "level", array()) == "3")) ? ("selected") : (null));
...
";
  ...
  \$(function() {
    ...
    ganti('";
        // line 110
        echo twig_escape_filter($this->env, $this->getAttribute(($context["user"] ?? null), "prodi_id", array()), "html", null, true);
        echo "');
  });
...
{% endblock %}", "user/ubah.twig", "/home/u7998733/public_html/data/application/views/user/ubah.twig");
    }
}
