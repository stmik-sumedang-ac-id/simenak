...
class __TwigTemplate_464d5cd25178e0cff641fa4ba1a984ad52069763528db3620cc174dcbe520058 extends Twig_Template
{
...
\t\t\t\t\t\t\t";
            // line 59
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["detil"]) ? $context["detil"] : null), $this->getAttribute($context["item"], "nomor", array()), array(), "array"));
...
\t \tvar var_last_tab = \"";
        // line 125
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["CI"]) ? $context["CI"] : null), "input", array()), "get", array(0 => "tab"), "method"), "html", null, true);
        echo "\";
...
\t  };
\t</script>
{% endblock %}", "pengajuan/detil_crud.twig", "/Users/yysofiyan/Desktop/Gitlab/ta_borang/application/views/pengajuan/detil_crud.twig");
    }
}
